import { Mail, Sparkles, Shield, Zap, BarChart3, Trash2 } from "lucide-react";
...
const Landing = () => {
  ...
  const handleGoogleLogin = () => {
    // For now, navigate to dashboard - will be replaced with actual OAuth
    navigate("/dashboard");
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 border-t border-border">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button onClick={handleGoogleLogin} size="lg" className="h-12 px-8">
            Get Started Free
          </Button>
        </div>
      </section>
